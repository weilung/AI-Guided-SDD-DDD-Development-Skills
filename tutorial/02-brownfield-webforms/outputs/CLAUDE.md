...
│   ├── context-map.md        # 候選 Bounded Context 與關係
...
- `/dflow:init-project` — 專案初始化（建立 `specs/` 結構；本專案已執行過）
...
- **Git 分支策略**：本專案採 Git Flow，見 `specs/shared/Git-principles-gitflow.md`
- **規格撰寫慣例**：見 `specs/shared/_conventions.md`
- **系統現況與遷移**：見 `specs/shared/_overview.md`
- **Tech debt backlog**：見 `specs/architecture/tech-debt.md`
...
- 詳細 Git 操作規則見 `specs/shared/Git-principles-gitflow.md`。
