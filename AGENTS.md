...
本 Repo 維護一套 AI 引導的 SDD（Specification-Driven Development）/ DDD（Domain-Driven Design）工作流程規範，設計用於 Codex 協作開發。
...
4. **英文版供 AI 使用**：英文版（無 `_tw` 後綴）是 Codex 實際引導開發時讀的檔案，必須精確、不模糊
